...
<ol>
	<li value="2">Настоящая публичная Оферта (в дальнейшем &mdash; Договор) является официальным предложением ООО &laquo;Альпина Паблишер&raquo; в адрес любого физического/юридического лица, обладающего дееспособностью и необходимым полномочием заключить с ООО &laquo;Альпина Паблишер&raquo; договор купли-продажи Товара на условиях, определенных в настоящей оферте и содержит все существенные условия договора.</li>
	<li value="3">Сообщая Продавцу свой e-mail и номер телефона, Посетитель Сайта/Покупатель дает согласие на использование указанных средств связи Продавцом, а также третьими лицами, привлекаемыми им для целей выполнения обязательств перед Посетителями Сайта/Покупателями, в целях осуществления рассылок рекламного и информационного характера, содержащих информацию о скидках, предстоящих и действующих акциях и других мероприятиях Продавца, о передаче заказа в доставку, а также иную информацию, непосредственно связанную с выполнением обязательств Покупателем в рамках настоящей Публичной оферты.</li>
	<li value="4">Отношения в области защиты прав потребителей регулируются Гражданским кодексом Российской Федерации, Законом &laquo;О защите прав потребителей&raquo; и принимаемыми в соответствии с ним иными федеральными законами и правовыми актами Российской Федерации.<br />
	&nbsp;</li>
</ol>
...
<ol>
	<li value="5">Момент заключения договора</li>
</ol>
&nbsp;
...
<ol>
	<li value="6">Права и обязанности сторон</li>
</ol>
&nbsp;
...
<ol>
	...
	<li value="5"><strong>Продавец имеет право:</strong>
	<ol>
	...
	<li value="6"><strong>Покупатель обязуется:</strong>
	<ol>
	...
	<li value="7"><strong>Покупатель имеет право:</strong>
	<ol>
		<li value="0">Покупатель вправе отказаться от получения e-mail и sms-рассылок, для этого ему нужно нажать на ссылку &laquo;Отписаться&raquo;, указанную в рассылке<br />
		&nbsp;</li>
	</ol>
	</li>
</ol>
...
<ol>
	...
	<li value="5">Стоимость доставки каждого Заказа рассчитывается индивидуально, исходя из&nbsp;веса Товара, региона и&nbsp;способа доставки, а&nbsp;также (в&nbsp;случае необходимости) формы оплаты, и&nbsp;указывается на&nbsp;Сайте на&nbsp;последнем этапе оформления Заказа.</li>
	<li value="6">Обязанность Продавца передать товар Покупателю считается исполненной в&nbsp;момент вручения курьером Товара Получателю или получения Товара Получателем в&nbsp;отделении почтовой связи или в отделении постаматата или ПВЗ.</li>
	<li value="7">Время нахождения курьера по&nbsp;адресу Получателя ограничено 15&nbsp;минутами.</li>
	<li value="8">При курьерской доставке Товара Клиент в реестре Доставки ставит свою подпись. Данная подпись служит подтверждением того, что Клиент не имеет претензий к комплектации заказа, к количеству и внешнему виду Товара.&nbsp;</li>
	<li value="9">После получения Заказа претензии к&nbsp; количеству, комплектности и виду Товара не принимаются.</li>
