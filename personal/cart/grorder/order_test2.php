...
<table width="400"><tbody>
    ...
    <div style="width:220px;margin:0 auto;">
        <input id='jq_submit' style="width:220px;height:36px;text-align:center;background:#FF6418;background-size: 105px 32xp;border:1px solid #fafafa;color:white;font-family: 'FreeSet';font-size: 19px;font-weight: 400;padding:5px;margin-top:15px;margin:0 auto;cursor:pointer;margin-top:12px" type="submit" value="Перейти к оплате" />
    </div>
    </form>
    </div>                                
