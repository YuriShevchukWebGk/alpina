	...
	$ja.click(function(){
		...
		switch(idinput){
			case 'bk':{
				...
				$j('#bank_money_label, #bank_qiwi_label').css('color', '#666');
				...
				$j('#bank_qiwi_label, #bank_card_label').css('color', '#666');
				...
				$j('#bank_money_label, #bank_card_label').css('color', '#666');
				$j('.img_bank').html('<img src="img/bank_card_gr.png" width="35" style="margin:0 10px;" align="left" />');
				$j('.img_money').html('<img src="img/money_gr.png" width="35" style="margin:0 10px;" align="left" />');
...
При оплате заказа банковской картой (включая ввод номера карты), обработка платежа происходит на сайте системы электронных платежей ASSIST, которая прошла международную сертификацию. Это значит, что Ваши конфиденциальные данные (реквизиты карты, регистрационные данные и др.) не поступают в интернет-магазин, их обработка полностью защищена и никто, в том числе ООО «Альпина Паблишер» (сайт www.alpinabook.ru), не может получить персональные и банковские данные клиента.
	...
	<br /><br />
	<img src="img/assisty.png" align="center" />
	<br /><br />
	...
	<br /><br />
	<img src="img/logos.png" align="center" /><img src="img/MasterCard.png" align="center" /><img src="img/VISA.png" align="center" />
</div>
...
<table width="500" style="float:left"><tbody>
	...
	<tr>
		<td height="40">			
			...
			<label for="im" style="color: #666;font-family: 'FreeSet';font-size: 19px;font-weight: 400;cursor:pointer;" id="bank_money_label"><span class="img_money"><img src="img/money_gr.png" width="35" style="margin:0 10px;" align="left" /></span> Электронные деньги</label><br />
		</td height="40">
	</tr>
	<tr>
		<td height="40">			
...
<table width="400"><tbody>
	...
	<tr>
		...
		<td>
			<input type="text" size="25" name="name" style="background:transparent;border:2px solid #FF9C6A;height:20px;" value="<?=htmlspecialcharsbx($_POST["name"])?>" />
		</td>
	</tr>
	<tr>
		<td width="110" height="40">
		...
		<td>
			<input type="text" size="25" name="email" style="background:transparent;border:2px solid #FF9C6A;height:20px;" value="<?=htmlspecialcharsbx($_GET["email"])?>" required />
		</td>
	</tr>
	<tr>
		<td width="110" height="40">
		...
		<td>
			<input type="text" size="25" name="telephone" style="background:transparent;border:2px solid #FF9C6A;height:20px;" value="<?=htmlspecialcharsbx($_POST["phone"])?>" />
		</td>
	</tr>
				...
				<input type="hidden" name="paysum" value="3360" />
	...
	<div style="margin-left:55px;margin-top:30px;color:#777; font-size:14px;font-family: 'FreeSet';">
		*оплата через систему<br />электронных платежей Assist после<br />подтверждения заказа
	</div>	
