...
/*
//РЎРёРЅС…СЂРѕРЅРёР·Р°С†РёСЏ РѕСЃС‚Р°С‚РєРѕРІ РїСЂРё РІС‹РіСЂСѓР·РєРµ РІ РёРЅС„РѕР±Р»РѕРє 1РЎ
AddEventHandler("catalog", "OnProductUpdate", Array("Exchange1C", "SyncProductQuantity"));
AddEventHandler("catalog", "OnProductAdd", Array("Exchange1C", "SyncProductQuantity"));

//РЈРІРµРґРѕРјР»РµРЅРёРµ Рё СЃРјРµРЅР° СЃС‚Р°С‚СѓСЃР° СЃ 0 РѕСЃС‚Р°С‚РєР°С… РЅР° СЃР°Р№С‚Рµ
AddEventHandler("catalog", "OnBeforeProductUpdate", Array("QuantityChanges", "QuantityOnZero"));

//Р›РѕРіРёСЂРѕРІР°РЅРёРµ РёР·РјРµРЅРµРЅРёР№ СЌР»РµРјРµРЅС‚РѕРІ
AddEventHandler("iblock", "OnAfterIBlockElementAdd", Array("Exchange1C", "SyncProductQuantityIblock"));
AddEventHandler("iblock", "OnAfterIBlockElementUpdate", Array("Exchange1C", "SyncProductQuantityIblock"));
...
class QuantityChanges {
    function QuantityOnZero($ID, $arFields) {
        if($arFields['QUANTITY'] <= 0 && CModule::IncludeModule('iblock')) {
            ...
            if ($ob = $res->GetNextElement()) {
                $ar_product = $ob->GetFields();
                //РџСЂРѕРІРµСЂРёРј РЅРµ СЏРІР»СЏРµС‚СЃСЏ Р»Рё РїСЂРµРґР·Р°РєР°Р·РѕРј Рё РЅРµ Р±С‹Р» Р»Рё СЂР°РЅРµРµ РѕС‚СЃС‚Р°С‚РѕРє РјРµРЅСЊС€Рµ 0, РїРѕСЃР»Рµ С‡РµРіРѕ РѕС‚РїСЂР°РІРёРј СЃРѕРѕР±С‰РµРЅРёРµ Рё РїРѕРјРµРЅСЏРµРј СЃС‚Р°С‚СѓСЃ
                if(($ar_product['PROPERTY_STATE_ENUM_ID'] != getXMLIDByCode(CATALOG_IBLOCK_ID, "STATE", "soon")) && ($ar_product['CATALOG_QUANTITY'] <= 0)) {
...
class Exchange1C {
    function SyncProductQuantity($ID, $arFields) {
        ...
        //РџРµСЂРІС‹Р№ Р·Р°РїСЂРѕСЃ РґР»СЏ РїРѕР»СѓС‡РµРЅРёСЏ Р·РЅР°С‡РµРЅРёСЏ Bitrix ID
        $arSelect = Array("PROPERTY_ID_BITRIKS");
        $arFilter = Array("ID"=>$ID, "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y");
        ...
        if(!empty($bitrix_id)) {
            ...
            //Р—Р°РїСЂРѕСЃ РґР»СЏ РїРѕР»СѓС‡РµРЅРёСЏ РѕСЃС‚Р°С‚РєРѕРІ Сѓ СЌР»РµРјРµРЅС‚РѕРІ, РєРѕС‚РѕСЂС‹Рµ РїСЂРёРІСЏР·Р°РЅС‹ Рє С‚РѕРјСѓ Р¶Рµ С‚РѕРІР°СЂСѓ РІ РєР°С‚Р°Р»РѕРіРµ
            ...
            //Р—Р°РїСЂРѕСЃРµ РЅР° РѕР±РЅРѕРІР»РµРЅРёРµ РѕСЃС‚Р°С‚РєРѕРІ Сѓ С‚РѕРІР°СЂР°
            $arFields = array('QUANTITY' => $total_quantity);// Р·Р°СЂРµР·РµСЂРІРёСЂРѕРІР°РЅРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ
