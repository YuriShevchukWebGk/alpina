    ...
    class Message {
        ...
        *************/
        public static $messages = Array(
			...
			"PD" => "Здравствуйте, clientName! Ваш заказ №order из интернет-магазина «Альпина Паблишер» доставлен почтовое отделение. Придите отделение и назовите оператору трекинг-код tracking. С собой необходимо иметь паспорт. Спасибо!",
			"P10" => "Здравствуйте, clientName! Пожалуйста, заберите Ваш заказ из магазина «Альпина Паблишер» в Вашем почтовом отделении.",
			"PA" => "Здравствуйте, clientName! Срок хранения Вашего заказ №order из интернет-магазина «Альпина Паблишер» истекает. Пожалуйста, заберите заказ в почтовом отделении. Трекинг-код tracking. Спасибо!"			
