...
?>
<style>.stopProp img {max-width:650px;height:auto;display:block;margin:0 auto;padding:20px 0;}.awayLink:hover {background-color: #cab796!important;color: #fff!important;} .addLink:hover {background-color: #c7a271!important;color: #fff!important;} .closeIcon:after {position: absolute;background: url("/img/close.png") left center;width: 21px;height: 21px;right: 40px;top: 30px;margin-left: -15px;margin-top: -8px;cursor: pointer;display: block;content: "";} .closeIcon:hover:after {background: url("/img/close.png") right center;}</style><script>$(document).ready(function() { $(".stopProp").click(function(e) { e.stopPropagation(); }); });</script>

<div style="position: fixed; width: 100%; height: 100%; top: 0; left: 0; z-index: 999999999998; background: rgba(206,206,206,.62);overflow-y:auto;" onclick="closeInfo();" class="hideInfo"><div style="max-width: 800px; width:100%;margin-left: -410px; margin-top: 7%;margin-bottom:7%;box-shadow: 0 0 1px 0px rgba(0,0,0,.7); top: 0; left: 50%; position: absolute; background: #fff; padding: 30px 40px; z-index: 999999999999;display: block;font-family: 'Walshein_regular';color:#2F3839" class="stopProp infoPopup"><div class="closeIcon" style="cursor:pointer;" onclick="closeInfo();"></div><div>
<?
...
if (strlen($arResult["MESSAGE"]) > 0):?>
    ...
    <div class="contacsFormMessage">Ваше сообщение успешно отправлено. Мы ответим в рабочее время на Ваш e-mail</div>
