...
?>
                ...
                <div class="book bookSoon">
                    <div class="firstWrapp">
                        <div class="coverSmall">
                            <?$left_upper_pict = CFile::ResizeImageGet($arResult["ITEMS"][1]["DETAIL_PICTURE"]["ID"], array('width'=>162, 'height'=>243), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                            ...
                            <a href="<?=$arResult["ITEMS"][1]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickSoon', 'label' : 'block1'});">
                        ...
                        <div class="coverSmall">
                            <?$left_lower_pict = CFile::ResizeImageGet($arResult["ITEMS"][2]["DETAIL_PICTURE"]["ID"], array('width'=>162, 'height'=>243), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                            ...
                            <a href="<?=$arResult["ITEMS"][2]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickSoon', 'label' : 'block2'});">
                    ...
                    <div class="secondWrapp">
                        <div class="cover">
                            ...
                            <a href="<?=$arResult["ITEMS"][0]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickSoon', 'label' : 'blockBig'});">
                    ...
                    <div class="thirdWrapp">
                        <div class="container">
                            <div class="coverSmall">
                                <?$right_upper_pict = CFile::ResizeImageGet($arResult["ITEMS"][3]["DETAIL_PICTURE"]["ID"], array('width'=>164, 'height'=>247), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                                ...
                                <a href="<?=$arResult["ITEMS"][3]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickSoon', 'label' : 'block3'});">
                            ...
                            <div class="coverSmall">
                                <?$right_lower_pict = CFile::ResizeImageGet($arResult["ITEMS"][4]["DETAIL_PICTURE"]["ID"], array('width'=>164, 'height'=>247), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                                ...
                                <a href="<?=$arResult["ITEMS"][4]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickSoon', 'label' : 'block4'});">
                        ...
                        <a href="/catalog/coming-soon/" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickSoon', 'label' : 'allBooks'});">
                            <div class="text">
                                <p>Книги, которые скоро поступят<br> в продажу</p>
                                Смотреть все
                            </div>
                        </a>
