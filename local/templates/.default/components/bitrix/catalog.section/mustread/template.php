...
<div class="wrapperCategor MustReadCategor">
    <div class="categoryWrapper">
        ...
        <div class="contentWrapp">
            <p class="titleMain"><?=($arResult["NAME"])?$arResult["NAME"]:GetMessage("MUSTREAD")?></p>
    ...
    $(document).ready(function() {
        ...
        $('.showMore').click(function(){
            ...
            .done(function() {
                    ...
                    var categorHeight = 1600 + Math.ceil(($(".otherBooks ul li").length - 15) / 5) * 400;
