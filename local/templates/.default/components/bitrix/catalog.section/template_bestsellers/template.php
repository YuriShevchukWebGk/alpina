                ...
                <div class="book bookBest">
                    <div class="firstWrapp">
                        <div class="coverSmall">
                            ...
                            <a href="<?=$arResult["ITEMS"][1]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickBest', 'label' : 'block1'});">
                        ...
                        <div class="coverSmall">
                            ...
                            <a href="<?=$arResult["ITEMS"][2]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickBest', 'label' : 'block2'});">
                    ...
                    <div class="secondWrapp">
                        <div class="cover">
                            ...
                            <a href="<?=$arResult["ITEMS"][0]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickBest', 'label' : 'blockBig'});">
                    ...
                    <div class="thirdWrapp">
                        <div class="container">
                            <div class="coverSmall">
                                ...
                                <a href="<?=$arResult["ITEMS"][3]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickBest', 'label' : 'block3'});">
                            ...
                            <div class="coverSmall">
                                ...
                                <a href="<?=$arResult["ITEMS"][4]["DETAIL_PAGE_URL"]?>" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickBest', 'label' : 'block4'});">
                        ...
                        <a href="/catalog/bestsellers/" onclick="dataLayer.push({'event' : 'topBlockOnMain', 'action' : 'bookClickBest', 'label' : 'allBooks'});">
                            <div class="text">
                                <p>Главные бестселлеры издательства Альпина Паблишер</p>
                                Смотреть все
                            </div>
                        </a>
