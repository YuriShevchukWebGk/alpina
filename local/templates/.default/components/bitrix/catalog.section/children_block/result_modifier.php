...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		if(!empty($arItem["PROPERTIES"]["BIG_SECTION_IMAGE"]["VALUE"])) {
			$arItem["BIG_ITEM"] = true;
		};
...
foreach ($arResult["ITEMS"] as $key => $arItem) {
    ...
    // ��������� ����������� ��� ������ � ������� ��������
	if($arItem["BIG_ITEM"]) {
    	$arResult[$arItem["ID"]]["PICTURE"] = CFile::ResizeImageGet($arItem["DETAIL_PICTURE"]["ID"], array('width'=>360, 'height'=>528), BX_RESIZE_IMAGE_PROPORTIONAL, true);
	} else {
