                            ...
                            <li>
                                <div class="categoryBooks">
                                    ...
                                    ?>
                                        ...
                                        <a class="product<?=$arItem["ID"];?>" href="<?echo $arItem["ADD_URL"]?>" onclick="addtocart(<?=$arItem["ID"];?>, '<?=$arItem["NAME"];?>', '<?= $arItem["PROPERTIES"]["STATE"]["VALUE_ENUM_ID"]?>');return false;"><p class="basketBook">Предзаказ</p></a>
                                    <?
                                    }
