...
$MESS['BANK_CARDS'] = "Сохраненные банковские карты";
$MESS['EXISTING_CARD_MESSAGE'] = "В данный момент для рекуррентных платежей используется карта с номером";
$MESS['EMPTY_CARD_MESSAGE'] = "В данный момент нет сохраненной карты для рекуррентных платежей";
$MESS['DELETE'] = "Удалить";
?>