...
<div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,pocket,telegram" data-counter=""></div>
    ...
    // $fb_meta = '<meta property="og:type" content="website" />'."\r\n";
    // $fb_meta .= '<meta property="og:url" content="'.'http://'.SITE_SERVER_NAME.$APPLICATION->GetCurPage().'" />'."\r\n";
    // $fb_meta .= '<meta property="og:site_name" content="ООО «Альпина Паблишер»" />'."\r\n";
    // $fb_meta .= '<meta property="og:locale" content="ru_RU" />'."\r\n";
