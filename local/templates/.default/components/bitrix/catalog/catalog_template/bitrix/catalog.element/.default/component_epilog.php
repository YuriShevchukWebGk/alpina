...
$description = 'Купить книгу: ' . $arResult["PROPERTIES"]["SHORT_NAME"]["VALUE"] . '; ' .$arResult["PROPERTIES"]["COVER_TYPE"]["VALUE"]. '; дата издания: ' . $arResult["PROPERTIES"]["YEAR"]["VALUE"] . '; 💳 цена ' .$arResult["PROPERTIES"]["YEAR"]["VALUE"] . ' &#8381;. Подробности заказа и доставки по 📲 +7 (495) 120 07 04.';
