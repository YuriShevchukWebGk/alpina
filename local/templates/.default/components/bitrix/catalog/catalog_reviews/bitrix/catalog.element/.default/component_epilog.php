...
$title .= " – Издание " . $arResult["PROPERTIES"]["YEAR"]["VALUE"];
...
$description = '📕 Читать рецензии на книгу: ' . $arResult["PROPERTIES"]["SHORT_NAME"]["VALUE"];
$description .= ': ' . $arResult["PROPERTIES"]["SECOND_NAME"]["VALUE"];
$description .= '; ' .$arResult["PROPERTIES"]["COVER_TYPE"]["VALUE"]. '; дата издания: ' . $arResult["PROPERTIES"]["YEAR"]["VALUE"] . '. Подробности заказа и доставки по 📲 +7 (495) 120 07 04.';
