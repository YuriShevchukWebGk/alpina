...
$title = "Отзывы о книге: " . $arResult["PROPERTIES"]["SHORT_NAME"]["VALUE"];

if(strlen($arResult["PROPERTIES"]["SECOND_NAME"]["VALUE"])){
	$title .= '. ' . $arResult["PROPERTIES"]["SECOND_NAME"]["VALUE"];
}
$title .= " – читать отзывы о прочитанной книге";
...
$description = '📕 Читать отзывы о книге ' . $arResult["PROPERTIES"]["SHORT_NAME"]["VALUE"] .': '. $arResult["PROPERTIES"]["SECOND_NAME"]["VALUE"] . '; ' .$arResult["PROPERTIES"]["COVER_TYPE"]["VALUE"]. '; дата издания: ' . $arResult["PROPERTIES"]["YEAR"]["VALUE"] . '. Подробности заказа и доставки по 📲 +7 (495) 120 07 04.';
