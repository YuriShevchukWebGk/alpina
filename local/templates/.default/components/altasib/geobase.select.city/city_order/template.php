...
$notAutoShowPopup = false;
            ...
            $_SESSION["city_order_checked"] = $usrSelCity; // записываем выбранный горд в сессию
            ?>
            ...
            <?}?>
            <a href='javascript:void(0);' class="altasib_geobase_link_city" ><?=GetMessage('REASPEKT_GEOIP_TITLE_YOU_CITY')?></a>
...
<?                        ?><li<?echo($arResult["CODE"] == $sel["C_CODE"] ? ' class="altasib_geobase_act"' : '')?>><?
                ...
                <a id="altasib_geobase_btn" class="altasib_geobase_disabled" href="javascript:void(0)"><?=GetMessage("ALTASIB_GEOBASE_THIS_IS_MY_".$sMode);?></a>
