...
class apishipHelper{
	...
	public static function auth($params){
		...
		else
		{
			...
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/local/modules/".apishipdriver::$MODULE_ID."/install/delivery/", $_SERVER["DOCUMENT_ROOT"]."/local/php_interface/include/sale_delivery/", true, true);
	...
	public static function logoff(){
		...
		DeleteDirFilesEx("/local/php_interface/include/sale_delivery/delivery_apiship.php");
	...
	function getNormalCityByLocationID($locationID)
	{
        ...
        if($arCity["ID"] != MOSCOW_LOCATION_ID){
            $arCity = array();
            $arCity["CITY_NAME"] = $_SESSION["city_order_checked"];
        }
		...
		if ($arCity)
		{
			...
			$cityDeleteParts = array(
                ...
                GetMessage("IPOLapiship_EXCEP_CITY_PGT_3"),
				GetMessage("IPOLapiship_EXCEP_CITY_PGT_4")
			);
