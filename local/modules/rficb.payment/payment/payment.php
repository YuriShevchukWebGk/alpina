...
?>
<?php if ($widget == "Y" && $widgettype ==2 && $ajax ==0) { ?>
<script type="text/javascript" src="https://partner.rficb.ru/gui/rfi_widget/js/v1.js"charset="utf-8"></script>
<a class="rfi_button" data-open="widget" data-key="<?= $key?>" data-cost="<?echo $cost?>" data-comment="<?echo $order_id?>" data-name="<?echo $name?>" data-orderid="0" data-email="<?echo $email?>"
href="#"><div style="width: 200px;
    height: 49px;background-image:url(https://partner.rficb.ru/gui/images/a1lite_buttons/button_small.png);"></div></a><br />
...
<?php if ($widget == "Y" && $widgettype ==1  && $ajax ==0) { ?>
