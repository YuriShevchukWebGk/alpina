...
<div class="howToBodyWrap">
	<div class="centerWrapper">	
		...
		<div class="tshirt">
			...
			<div class="description">Ага, попались! Эта сова никого не оставляет равнодушным. Будьте готовы к повышенному вниманию со стороны окружающих! Если вам интересны его истоки - в книге <ссылка> вы найдёте ответы на все волнующие вопросы. <br />
				<span class="price">
					<?=$price?> руб.
					<br /><br />
					<a href="#form"><span class="button">Заказать</span></a>
		...
		<div class="tshirt">
			<span class="title">Человек уставший (серая)</span>
						...
						<tr>
							<td>
								<select size="9" name="tshirt">
									...
									<option value='Не в знании сила (серая)'>Не в знании сила (серая)</option>
									<option value='Человек уставший (серая)'>Человек уставший (серая)</option>
