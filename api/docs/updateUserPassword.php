<?include('api_header.php')?>
        <div class="api_content">
            ...
            <div class="important">
		        <span>важно</span>
		        <span>Если пользователь не найден, то он будет создан с теми же параметрами методом <a href="/api/docs/addNew.php">addNew</a></span>
		    </div>
            ...
            <div class="code_example">
                <code>https://<?=$_SERVER['SERVER_NAME']?>/api/user/?method=updateUserPassword&token=123456789qwertyuiopasdfghjklzxcv&email=test@test.ru&password=123456</code>
            </div>
