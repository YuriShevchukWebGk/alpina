...
?>
<p class="info">Сменить пароль</p>
<div class="changePasWrapper">
<div class="bx_profile bx_<?=$arResult["THEME"]?>">
	<form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>?" enctype="multipart/form-data">
		...
		<input type="password" name="NEW_PASSWORD" maxlength="50" value="" autocomplete="off" placeholder="<?=GetMessage("NEW_PASSWORD_REQ")?>" class="changePasInp"/>
        <p class="infoText"><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></p>
		<?/*?><strong><?=GetMessage('NEW_PASSWORD_CONFIRM')?></strong><br/><?*/?>
		<input type="password" name="NEW_PASSWORD_CONFIRM" maxlength="50" value="" autocomplete="off" class="changePasInp" placeholder="<?=GetMessage('NEW_PASSWORD_CONFIRM')?>"/> 
		...
		<input name="save" value="Сменить пароль" class="bx_bt_button bx_big shadow" type="submit">
	</form>
</div>
</div>
<br>
