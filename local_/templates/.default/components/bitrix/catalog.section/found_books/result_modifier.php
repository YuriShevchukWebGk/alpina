...
{
    if (((mb_stripos($a["NAME"], $_REQUEST["q"], 0, "UTF-8") !== false) && (mb_stripos($b["NAME"], $_REQUEST["q"], 0, "UTF-8") !== false)) ||
       ((mb_stripos($a["NAME"], $_REQUEST["q"], 0, "UTF-8") === false) && (mb_stripos($b["NAME"], $_REQUEST["q"], 0, "UTF-8") === false)))  
       {
            return 0;
       }
    else if ((mb_stripos($a["NAME"], $_REQUEST["q"], 0, "UTF-8") !== false) && (mb_stripos($b["NAME"], $_REQUEST["q"], 0, "UTF-8") === false))
        {
            return -1;    
        }
    else
