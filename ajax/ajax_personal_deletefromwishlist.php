...
if ($_REQUEST["id"])
{
    $wish_item_list = CIBlockElement::GetList(array(), array("IBLOCK_ID" => 17, "NAME" => $USER -> GetID()), false, false, array("NAME", "ID", "PROPERTY_PRODUCTS"));
    while ($wish_item_fetch = $wish_item_list -> Fetch())
    {
        ...
        while ($prod_val = current($prod_values))
        {
            ...
            next($prod_values);
                ...
                $WishFilter = array ("NAME" => $USER -> GetID());
