...
foreach ($arBasketItems as $data) {      
    //РЎРѕС…СЂР°РЅСЏРµРј РёРЅС„РѕСЂРјР°С†РёСЋ Рѕ Р·Р°РєР°Р·Рµ РІ HL Р±Р»РѕРє             
    $result = $entity_data_class::add($data);            
    //РџРµСЂРµРІРѕРґРёРј РІСЃРµ С‚РѕРІР°СЂС‹ РІ РѕС‚Р»РѕР¶РµРЅРЅС‹Рµ, РєСЂРѕРјРµ РїСЂРµРґР·Р°РєР°Р·Р°РЅРЅРѕРіРѕ    
