...
if ($_REQUEST["info"])
{
	...
	switch ($_REQUEST["info"]) {
		case 'courier':
			...
			break;
		case 'boxberry':
			$info = "<h6>Пункты выдачи</h6><hr /><h6>Сроки доставки</h6><ul><li>от&nbsp;2&nbsp;дней. Вы&nbsp;увидите срок доставки после выбора пункта выдачи.</li></ul><h6>Стоимость доставки</h6><ul><li>сумма заказа от&nbsp;0&nbsp;до&nbsp;2&nbsp;000&nbsp;руб. &mdash;&nbsp;рассчитывается автоматически при оформлении заказа;</li><li>сумма заказа от&nbsp;2&nbsp;000&nbsp;руб. &mdash;&nbsp;БЕСПЛАТНО.</li></ul><h6>Дополнительная информация</h6><ul><li>необходимо внести 100% предоплату;</li><li><a href=\"http://boxberry.ru/tracking/\" target=\"_blank\">отслеживание заказов</a> на&nbsp;сайте Boxberry может начинаться с&nbsp;задержкой в&nbsp;несколько дней. Это связано с&nbsp;особенностями информобмена и&nbsp;комплектации заказов в&nbsp;интернет-магазине.</li></ul>";
			break;
		case 'pickup':
