...
<?$i = 0;?>
    ...
    <div class="landing">
        <div class="mainWrapp">
            <div class="slide1">
				<div id="slide1text">
                Здравствуйте, садитесь. А то упадете:<br />
				скидка на лучшие книги до <span>40%!</span>
				</div>
            </div>
			<div class="slide3">
				<div id="slide1text">
                С 1 по 7 сентября мы продаем лучшие<br />
				книги для учеников и студентов,<br />
				их родителей и учителей со скидкой до 40%
				</div>
            </div>
			<div class="slide4">
				<div id="slide1text">
