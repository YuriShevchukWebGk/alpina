...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Акция только для клиентов Райффайзен БАНКА</title>
...
<header style="border-bottom:1px solid #eee;">
    ...
    <div class="landing">
        <div class="mainWrapp">
            <div class="slide1">
				<div class="toptext">
					<img src="img/raifflogo.png" style="float:left;" />
					<img src="img/aplogo.png" style="float:right;" />
					<div class="clear">
					Совместный проект Интернет-магазин издательства
					<br />
					Альпина Паблишер и Райффайзен БАНКА
					</div>
				</div>
			</div>
            <div class="slide2">
				<h1>
					Для клиентов Райффайзен БАНКА
				</h1>
				<h2>
					СКИДКА 10%
				</h2>
            ...
            <div class="slide3">
				...
				<div class="clear"></div>
				<a href="/catalog/bestsellers/?from=raiffeisenbanklanding">Перейти к покупкам</a>
			</div>
