    ...
    <div class="landing">
        <div class="mainWrapp">
			...
			<div class="slide5">
				...
				Если вы закажете книг в подарок на сумму более 20 000 рублей, мы сделаем вам скидку 20%
				<br />
				</div>
            </div>				
			<div class="slide6">
			...
			<div class="slide3">
				...
				фотографией любимого кота вашего босса или с чем вы захотите при тираже от 300 книг :)
				</div>
            </div>			
