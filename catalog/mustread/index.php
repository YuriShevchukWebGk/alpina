...
$APPLICATION->SetTitle("Must read");
...
<?
global $arrFilter_mustread;
$arrFilter_mustread = array('PROPERTY_must_read' => '242');
?>
<?$APPLICATION->IncludeComponent("bitrix:catalog.section", "mustread", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"FILTER_NAME" => "arrFilter_mustread",	// Имя массива со значениями фильтра для фильтрации элементов
