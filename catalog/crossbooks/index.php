...
$APPLICATION->SetTitle("С заказанными книгами читают");
...
global $arrFilter;
if (isset($_SESSION['retailRocketRecs'])){
	$stringRecs = file_get_contents('https://api.retailrocket.ru/api/1.0/Recomendation/CrossSellItemToItems/50b90f71b994b319dc5fd855/'.(substr($_SESSION['retailRocketRecs'],0,-1)));
