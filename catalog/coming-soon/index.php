...
$APPLICATION->SetTitle("Скоро в продаже");
$APPLICATION->SetPageProperty("description", "Скоро в продаже");
...
<?$APPLICATION->IncludeComponent("bitrix:catalog.section", "coming-soon", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"BROWSER_TITLE" => "UF_META_DESCRIPTION",	// Установить заголовок окна браузера из свойства
		...
		"FILTER_NAME" => "arrFilter_soon",	// Имя массива со значениями фильтра для фильтрации элементов
