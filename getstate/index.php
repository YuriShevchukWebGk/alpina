...
//8764
$rs = CIBlockElement::GetList(array(), array("IBLOCK_ID" => 4, "ID" => explode(",", $_GET["ids"])));
$res = array();

while($book = $rs->GetNextElement()) {
  array_push($res, array($book->fields["ID"] => ($book->GetProperties()["STATE"]["VALUE_XML_ID"] != "net_v_nal")));
}
