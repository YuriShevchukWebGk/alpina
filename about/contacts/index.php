    ...
    <div class="contactsBodyWrap">
        <div class="centerWrapper">
            ...
            <div class="contactsTextWrap" itemprop="mainEntity" itemscope itemtype="http://schema.org/BookStore">
				...
				<p>Метро «Полежаевская» (или БЦК «Хорошёвская»), последний вагон из центра, из вестибюля направо, выход на улицу налево. На улице переходите на противоположную сторону к ТЦ «Хорошо», поворачиваете направо и двигаетесь по 4-ой Магистральной улице. Проходите магазин «Ларес» и доходите до «БЦ на Магистральной» (д. 5 стр. 1). Вам нужен второй подъезд, второй этаж.</p>
            </div>
        </div>
    </div>
